...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.OneToOneField(help_text='ID of user for who task is assigned', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='task',
            name='related_column',
        ...
        migrations.AddField(
            model_name='comment',
            name='related_task',
            field=models.ForeignKey(help_text='ID of task for which this one is related', on_delete=django.db.models.deletion.CASCADE, to='desk.Task'),
        ),
        migrations.AddField(
            model_name='column',
            name='author',
